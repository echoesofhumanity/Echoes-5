(function(){
  ...
  const start=async()=>{
    try{
      ...
      journey.innerHTML='<style>.echoes-human-light{position:absolute;pointer-events:none;border-radius:50%;filter:blur(52px);mix-blend-mode:screen;will-change:transform,opacity}.echoes-human-light-01{width:46vw;height:32vh;left:-8vw;top:34%;background:radial-gradient(ellipse at center,rgba(196,161,103,.095) 0%,rgba(151,126,86,.045) 38%,transparent 72%);opacity:.46;animation:echoesHumanLightOne 38s ease-in-out infinite alternate}.echoes-human-light-02{width:40vw;height:28vh;right:-7vw;top:69%;background:radial-gradient(ellipse at center,rgba(184,151,96,.075) 0%,rgba(129,111,78,.032) 42%,transparent 74%);opacity:.38;animation:echoesHumanLightTwo 46s ease-in-out infinite alternate}@keyframes echoesHumanLightOne{0%{transform:translate3d(-2%,-1%,0) scale(.97);opacity:.34}50%{transform:translate3d(3%,2%,0) scale(1.04);opacity:.50}100%{transform:translate3d(1%,4%,0) scale(1.01);opacity:.40}}@keyframes echoesHumanLightTwo{0%{transform:translate3d(2%,-2%,0) scale(1);opacity:.30}50%{transform:translate3d(-3%,2%,0) scale(1.045);opacity:.43}100%{transform:translate3d(-1%,4%,0) scale(.99);opacity:.35}}@media(max-width:699px){.echoes-human-light-01{width:92vw;height:27vh;left:-38vw;top:35%;filter:blur(46px);opacity:.42}.echoes-human-light-02{width:88vw;height:25vh;right:-40vw;top:70%;filter:blur(44px);opacity:.35}}@media(prefers-reduced-motion:reduce){.echoes-human-light{animation:none!important}}</style><div class="echoes-journey-field echoes-journey-field-01"><div class="echoes-field-path echoes-field-path-far echoes-field-path-01"></div><div class="echoes-field-path echoes-field-path-mid echoes-field-path-02"></div></div><div class="echoes-journey-field echoes-journey-field-02"><div class="echoes-field-path echoes-field-path-far echoes-field-path-03"></div><div class="echoes-field-path echoes-field-path-mid echoes-field-path-04"></div></div><div class="echoes-journey-field echoes-journey-field-03"><div class="echoes-field-path echoes-field-path-far echoes-field-path-05"></div><div class="echoes-field-path echoes-field-path-mid echoes-field-path-06"></div></div><div class="echoes-human-light-field"><div class="echoes-human-light echoes-human-light-01"></div><div class="echoes-human-light echoes-human-light-02"></div></div>';
