(function(){
  ...
  const start=async()=>{
    try{
      ...
      journey.innerHTML='<style>.echoes-human-light-field{position:absolute;top:0;left:0;width:100%;height:100%;pointer-events:none;overflow:hidden;background:radial-gradient(ellipse 46vw 34vh at 18% 28%,rgba(70,135,139,.042) 0%,rgba(48,98,106,.018) 42%,transparent 74%),radial-gradient(ellipse 42vw 30vh at 84% 58%,rgba(113,132,111,.032) 0%,rgba(70,91,83,.014) 44%,transparent 76%),radial-gradient(ellipse 34vw 26vh at 32% 82%,rgba(185,160,111,.026) 0%,rgba(118,94,62,.010) 40%,transparent 72%);filter:blur(24px);opacity:.78;animation:echoesColorPocketDrift 46s ease-in-out infinite alternate;transform-origin:50% 50%}@keyframes echoesColorPocketDrift{0%{transform:translate3d(-1.5%,-1%,0) scale(1)}50%{transform:translate3d(1.5%,1.2%,0) scale(1.025)}100%{transform:translate3d(-.5%,2%,0) scale(1.01)}}.echoes-human-light{position:absolute;pointer-events:none;border-radius:50%;mix-blend-mode:screen;will-change:transform,opacity,filter;background:radial-gradient(circle at 48% 46%,rgba(255,239,205,.82) 0%,rgba(232,199,139,.42) 20%,rgba(177,145,94,.14) 46%,transparent 76%);box-shadow:0 0 16px rgba(231,199,140,.18),0 0 38px rgba(190,154,96,.09);filter:blur(.4px);animation:echoesHumanPresence 26s ease-in-out infinite alternate}.echoes-human-light-01{width:15px;height:15px;left:14%;top:14%;animation-duration:23s;animation-delay:-3s}.echoes-human-light-02{width:11px;height:11px;right:18%;top:25%;animation-duration:31s;animation-delay:-11s}.echoes-human-light-03{width:17px;height:17px;left:29%;top:38%;animation-duration:28s;animation-delay:-7s}.echoes-human-light-04{width:10px;height:10px;right:31%;top:47%;animation-duration:35s;animation-delay:-16s}.echoes-human-light-05{width:14px;height:14px;left:11%;top:59%;animation-duration:33s;animation-delay:-9s}.echoes-human-light-06{width:16px;height:16px;right:12%;top:67%;animation-duration:25s;animation-delay:-14s}.echoes-human-light-07{width:11px;height:11px;left:38%;top:76%;animation-duration:37s;animation-delay:-5s}.echoes-human-light-08{width:15px;height:15px;right:36%;top:86%;animation-duration:29s;animation-delay:-18s}.echoes-human-light-09{width:10px;height:10px;left:19%;top:93%;animation-duration:39s;animation-delay:-13s}@keyframes echoesHumanPresence{0%{transform:translate3d(-3px,-2px,0) scale(.88);opacity:.28;filter:blur(.8px)}38%{opacity:.48}67%{transform:translate3d(4px,3px,0) scale(1.08);opacity:.68;filter:blur(.3px)}100%{transform:translate3d(1px,6px,0) scale(.95);opacity:.34;filter:blur(.65px)}}.echoes-global-pulse{position:absolute;pointer-events:none;border-radius:50%;z-index:0;background:radial-gradient(circle,rgba(95,208,197,.34) 0%,rgba(95,208,197,.13) 24%,rgba(95,208,197,.038) 49%,rgba(95,208,197,0) 76%);box-shadow:0 0 28px rgba(95,208,197,.06);opacity:.22;transform:translate(-50%,-50%) scale(.88);animation:echoesGlobalPulse 11s ease-in-out infinite}.echoes-global-pulse-01{width:88px;height:88px;left:16%;animation-delay:-1.5s}.echoes-global-pulse-02{width:112px;height:112px;left:84%;animation-delay:-4s}.echoes-global-pulse-03{width:72px;height:72px;left:22%;animation-delay:-2.5s}@keyframes echoesGlobalPulse{0%,100%{opacity:.13;transform:translate(-50%,-50%) scale(.86);filter:blur(1.8px)}50%{opacity:.40;transform:translate(-50%,-50%) scale(1.08);filter:blur(.8px)}}@media(max-width:699px){.echoes-human-light-field{background:radial-gradient(ellipse 86vw 28vh at 8% 24%,rgba(70,135,139,.045) 0%,rgba(48,98,106,.018) 42%,transparent 74%),radial-gradient(ellipse 82vw 27vh at 94% 57%,rgba(113,132,111,.034) 0%,rgba(70,91,83,.014) 44%,transparent 76%),radial-gradient(ellipse 74vw 24vh at 24% 84%,rgba(185,160,111,.028) 0%,rgba(118,94,62,.011) 40%,transparent 72%);filter:blur(22px);opacity:.82}.echoes-human-light{box-shadow:0 0 14px rgba(231,199,140,.16),0 0 32px rgba(190,154,96,.08)}.echoes-human-light-01{left:10%}.echoes-human-light-02{right:11%}.echoes-human-light-03{left:24%}.echoes-human-light-04{right:24%}.echoes-human-light-05{left:8%}.echoes-human-light-06{right:8%}.echoes-human-light-07{left:32%}.echoes-human-light-08{right:29%}.echoes-human-light-09{left:15%}}@media(prefers-reduced-motion:reduce){.echoes-human-light-field,.echoes-human-light,.echoes-global-pulse{animation:none!important}.echoes-human-light{opacity:.42}.echoes-global-pulse{opacity:.22}}</style><div class="echoes-journey-field echoes-journey-field-01"><div class="echoes-field-path echoes-field-path-far echoes-field-path-01"></div><div class="echoes-field-path echoes-field-path-mid echoes-field-path-02"></div></div><div class="echoes-journey-field echoes-journey-field-02"><div class="echoes-field-path echoes-field-path-far echoes-field-path-03"></div><div class="echoes-field-path echoes-field-path-mid echoes-field-path-04"></div></div><div class="echoes-journey-field echoes-journey-field-03"><div class="echoes-field-path echoes-field-path-far echoes-field-path-05"></div><div class="echoes-field-path echoes-field-path-mid echoes-field-path-06"></div></div><div class="echoes-human-light-field"><div class="echoes-human-light echoes-human-light-01"></div><div class="echoes-human-light echoes-human-light-02"></div><div class="echoes-human-light echoes-human-light-03"></div><div class="echoes-human-light echoes-human-light-04"></div><div class="echoes-human-light echoes-human-light-05"></div><div class="echoes-human-light echoes-human-light-06"></div><div class="echoes-human-light echoes-human-light-07"></div><div class="echoes-human-light echoes-human-light-08"></div><div class="echoes-human-light echoes-human-light-09"></div></div>';
      ...
      const journeyHeight=Math.max(document.documentElement.scrollHeight,document.body.scrollHeight);
      journey.style.height=journeyHeight+"px";
      const humanLightField=journey.querySelector(".echoes-human-light-field");
      if(humanLightField){
      ...
      if(page!=="home"&&page!=="about"){
        const pulseAnchors=page==="marketplace"?[
          document.querySelector("[data-section=\"search\"]"),
          document.querySelector("[data-section=\"featured\"]"),
          document.querySelector("[data-section=\"economy\"]")
        ]:[
