(function(){
  ...
  const start=async()=>{
    try{
      ...
      if(page==="marketplace"){await load("[data-section=\"search\"]","sections/marketplace/search.html");await load("[data-section=\"stores\"]","sections/marketplace/stores.html");await load("[data-section=\"featured\"]","sections/marketplace/featured.html");await load("[data-section=\"products\"]","sections/marketplace/products.html");await load("[data-section=\"library\"]","sections/marketplace/library.html");}
