(function(){
  ...
  const start=async()=>{
    try{
      ...
      atmosphere.innerHTML='<div class="echoes-depth-far" style="position:absolute;inset:-18%;pointer-events:none;opacity:.72;filter:blur(34px);background:radial-gradient(ellipse 58% 42% at 12% 22%,rgba(31,70,91,.13) 0%,rgba(18,43,61,.055) 42%,transparent 76%),radial-gradient(ellipse 52% 38% at 88% 68%,rgba(92,79,61,.075) 0%,rgba(53,57,52,.032) 44%,transparent 78%),radial-gradient(ellipse 46% 34% at 54% 92%,rgba(40,83,86,.06) 0%,transparent 74%)"></div><div class="echoes-depth-middle" style="position:absolute;inset:-14%;pointer-events:none;opacity:.54;filter:blur(22px);background:radial-gradient(ellipse 48% 34% at 78% 18%,rgba(39,91,101,.105) 0%,rgba(25,59,70,.04) 46%,transparent 76%),radial-gradient(ellipse 44% 32% at 18% 58%,rgba(50,89,91,.085) 0%,rgba(27,55,62,.035) 48%,transparent 78%),radial-gradient(ellipse 40% 28% at 72% 88%,rgba(105,87,62,.05) 0%,transparent 74%);animation:echoesMiddleDepthDrift 44s ease-in-out infinite alternate;transform-origin:50% 50%"></div><style>@keyframes echoesMiddleDepthDrift{0%{transform:translate3d(-1.5%,-1%,0) scale(1)}50%{transform:translate3d(1.8%,1.2%,0) scale(1.025)}100%{transform:translate3d(-.5%,2%,0) scale(1.012)}}@media (prefers-reduced-motion:reduce){.echoes-depth-middle{animation:none!important}}</style><div class="echoes-depth"></div><div class="echoes-cloud echoes-cloud-01"></div><div class="echoes-cloud echoes-cloud-02"></div>';

      const journey=document.createElement("div");
      journey.className="echoes-journey";
      journey.setAttribute("aria-hidden","true");
      journey.innerHTML='<div class="echoes-journey-field echoes-journey-field-01"><div class="echoes-field-path echoes-field-path-far echoes-field-path-01"></div><div class="echoes-field-path echoes-field-path-mid echoes-field-path-02"></div></div><div class="echoes-journey-field echoes-journey-field-02"><div class="echoes-field-path echoes-field-path-far echoes-field-path-03"></div><div class="echoes-field-path echoes-field-path-mid echoes-field-path-04"></div></div><div class="echoes-journey-field echoes-journey-field-03"><div class="echoes-field-path echoes-field-path-far echoes-field-path-05"></div><div class="echoes-field-path echoes-field-path-mid echoes-field-path-06"></div></div><div class="echoes-human-light-field"></div>';
